if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (a) {
        ...
        t.prototype = {
            ...
            _close: function () {
                ...
                if (b.bgOverlay.detach(), b.wrap.detach(),
                    b.container.empty(), b.st.mainClass && (c += b.st.mainClass + " "), b._removeClassFromMFP(c), b.fixedContentPos) {
                    var e = {
                        marginRight: ""
                    };
    ...
    function (a) {
        "use strict";
        a(".navbar-nav li a").click(function (b) {
            a(".in").collapse("hide")
        }), a("a.scroll[href*=#]:not([href=#])").click(function () {
            ...
            singleItem: !0,
            pagination: !1
        }), a('[data-toggle="tooltip"]').tooltip(), a(".image-link").magnificPopup({
            type: "image"
        }), a(".map").each(function () {
            var b = 17;
            void 0 !== a(this).attr("data-zoom") && (b = parseInt(a(this).attr("data-zoom"), 10)), a(this).gmap3({
                marker: {
                    values: [{
